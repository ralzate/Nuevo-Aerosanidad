...
RSpec.describe "procedimientos_medicos_y_de_enfermeria/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit procedimiento_medico_y_de_enfermeria form" do
    render

    assert_select "form[action=?][method=?]", procedimiento_medico_y_de_enfermeria_path(@procedimiento_medico_y_de_enfermeria), "post" do
